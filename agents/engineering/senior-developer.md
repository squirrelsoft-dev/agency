...
**Code Quality**:
- Test coverage: ≥ 85% overall, 100% for critical business logic
...
- Code review approval: ≥ 95% (high-quality implementations)
...
**Planning Phase**:
- **Project Owner/User** → High-level requirements and business goals
...
**Quality Assurance**:
- **QA/Testing Teams** ← Comprehensive test coverage and documentation
  - **Output Format**: Unit tests, integration tests, E2E tests, test documentation
  - **Quality Gate**: ≥ 85% coverage, all critical paths tested, edge cases handled
