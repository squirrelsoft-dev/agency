...
**Command Workflow**:
1. **Planning Phase** (`/agency:plan`): Feedback strategy validation, collection methodology review, analysis framework assessment, stakeholder alignment
2. **Execution Phase** (`/agency:work`): Multi-channel data collection, sentiment analysis execution, thematic synthesis, priority scoring, insight delivery
